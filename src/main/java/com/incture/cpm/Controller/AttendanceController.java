...
public class AttendanceController {
    ...
    public ResponseEntity<Optional<List<Attendance>>> getAttendanceByDateRangeAndTalent(
        ...
        Optional<List<Attendance>> attendanceList = attendanceService.getAttendanceByDateRangeAndTalent(startDate,
                endDate, talentId);
        ...
        if (attendanceList.isPresent()) {
            ...
            throw new ResourceNotFoundException(
                    "No attendance found for the given date range and talent ID: " + talentId);
        }
    }
    ...
    public ResponseEntity<Optional<List<Attendance>>> getAttendanceByDateRM(
        ...
        if (attendanceList.isPresent()) {
            ...
            throw new ResourceNotFoundException(
                    "No attendance found for the date: " + date + " and reporting manager: " + reportingManager);
        }
    }
}
