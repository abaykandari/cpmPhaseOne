...
public class TalentAssessmentService {
    ...
    public String save(MultipartFile file) {
        try {
            List<TalentAssessment> assessmentList = AssessmentHelp.convertExcelToAssessmentRecord(file.getInputStream());
    ...
    public String saveIndividually(List<TalentAssessment> assessmentList) {
        try {
            for (TalentAssessment assessment : assessmentList) {
                Optional<TalentAssessment> assessmentRepoFetch = assessmentRepository.findByAssessmentIdAndTalentId(assessment.getAssessmentId(), assessment.getTalentId());
