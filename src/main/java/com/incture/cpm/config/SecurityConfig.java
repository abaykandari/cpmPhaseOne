    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .cors(cors -> cors.configurationSource(request -> {
                    ...
                    config.setAllowedOrigins(Arrays.asList("http://192.168.1.4:5173", "http://localhost:5173", "http://localhost:3000", "http://192.168.0.137:3000", "http://192.168.137.216:3000"));
